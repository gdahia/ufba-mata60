...
% TODO: explain that we do not have temporal information. the model is time agnostic

% TODO: say that similar reasoning also applies to standard
...
% TODO: get exact number of classes in dataset, to state random performance for standard task

% TODO: get exact number of attributes fed to the models
